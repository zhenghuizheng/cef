...
#include "leak_annotations.h"
#include "trace_event.h"
#include "trace_event_synthetic_delay.h"
				...
				while (tokens.GetNext()) {
					...
					if (duration_end != token.c_str()) {
						delay->SetTargetDuration(
							TimeDelta::FromMicroseconds(static_cast<int64>(target_duration * 1e6)));
					}
